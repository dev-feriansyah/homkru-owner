...
class AppColorExtension extends ThemeExtension<AppColorExtension> {
  ...
  factory AppColorExtension.light() {
    return const AppColorExtension(
      ...
      silver2: Color(0xFFF5F5F5), // Note: original had .withValues(alpha: 10) which seems incorrect
      greyAA: Color(0xFFAAAAAA),

      // Success colors (green variations)
      successColor: Color(0xFF4CAF50), // Previously: brightGreen for visual states
